    ...
    },
    {
      ...
      config = function()
        require("noice").setup({
          cmdline = {
            enabled = true,
            view = "cmdline_popup", -- Cambia a cmdline_popup para centrar la barra de comandos
            opts = {
              position = {
                -- row = "75%", -- Centra verticalmente
              ...
              border = {
                style = "single", -- Borde simple para la ventana flotante
              },
            },
          },
          presets = {
